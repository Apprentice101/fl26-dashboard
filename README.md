# FL-26 Voting Procedures Dashboard

FL-26 (Mario Díaz-Balart R-inc since 2003, safe R Miami-Dade)
...
```bash
# In Apprentice101/fl26-dashboard repo:
git add .
git commit -m "Deploy FL-26 dashboard"
